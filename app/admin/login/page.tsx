    ...
    <div className="min-h-screen bg-gray-50 dark:bg-arena-900 flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black tracking-widest text-gray-900 dark:text-white">PROST ADMIN</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Staff sign in</p>
        </div>
        ...
        <form onSubmit={onSubmit} className="bg-white dark:bg-arena-800 rounded-3xl shadow-xl p-8 space-y-4">
          <div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Are you a customer? <a href="/login" className="text-brand-500 hover:underline">Use the customer login</a>
        </p>
      </motion.div>
    </div>
  );
