  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        ...
        <input type="email" placeholder="you@example.com" className="input" autoCapitalize="none" {...field('email')} />
      ...
      <div>
        ...
        <input type="text" placeholder="Friend's referral code" className="input uppercase" {...field('referralCode')} />
      </div>
      <motion.button type="submit" disabled={isLoading} whileTap={{ scale: 0.98 }} className="btn-primary w-full py-3.5">
        {isLoading
          ? <span className="flex items-center justify-center gap-2"><motion.span animate={{ rotate: 360 }} transition={{ repeat: Infinity, duration: 0.8, ease: 'linear' }} className="inline-block">⟳</motion.span>Creating account…</span>
...
function PhoneForm() {
  ...
  const handleVerifyOtp = async () => {
    ...
    try {
      ...
      toast.success('Welcome to the Arena! 🏟️');
      router.push('/home');
    } catch (err: any) {
      ...
      <div className="space-y-5">
        ...
        <div className="text-center py-2">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Code sent to <span className="font-semibold text-gray-900 dark:text-white">{phone}</span>
          </p>
        </div>
        <div>
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        ...
        <input type="text" placeholder="Friend's referral code" className="input uppercase" value={referralCode} onChange={(e) => setReferralCode(e.target.value)} />
      </div>
      <motion.button
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-arena-900 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-white dark:bg-arena-800 rounded-3xl shadow-xl p-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Join the Arena</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mb-6">Create your account and start earning XP</p>
